                ...
                <div class="card">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        ...
                        <div class="d-flex gap-2">
                            <a href="{{ route('admin.receiver-groups.edit', $receiverGroup) }}" class="btn btn-warning">
                                <i class='bx bx-edit'></i> Edit
                            </a>
                            <a href="{{ route('admin.receiver-groups.index') }}" class="btn btn-secondary">
                    ...
                    <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge bg-secondary">
                                                {{ $receiverGroup->user->name }} ({{ $receiverGroup->user->email }})
                                            </span>
                                        </td>
                                    </tr>
                                    <tr>
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <form action="{{ route('admin.receiver-groups.destroy', $receiverGroup) }}" method="POST"
                                class="d-inline"
