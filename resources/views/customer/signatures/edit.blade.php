            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h3 class="card-title mb-0">Edit Signature: {{ $signature->title }}</h3>
                    ...
                    <div class="card-body">
                        <div id="signatureApp">
                            <form method="POST" action="{{ route('customer.signatures.update', $signature) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('title') is-invalid @enderror"
                                        id="title" name="title" value="{{ old('title', $signature->title) }}"
                                        required>
                                    @error('title')
                                ...
                                <div class="mb-3" v-show="signatureType === 'image'">
                                    <label for="signature_image" class="form-label">Replace Signature Image
                                        (Optional)</label>
                                    <input type="file"
                                    ...
                                    <div class="form-text">Leave empty to keep the current signature. Supported formats:
                                        PNG, JPG, JPEG, GIF. Max size: 2MB</div>
                                ...
                                <div class="mb-3" v-show="signatureType === 'draw'">
                                    <label class="form-label">Draw Your Signature (Optional - leave blank to keep
                                        current)</label>
                                ...
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="is_active" name="is_active"
                                            value="1" {{ old('is_active', $signature->is_active) ? 'checked' : '' }}>
                                ...
                                <div class="d-flex gap-2">
                                    <button type="submit" class="btn btn-primary">
                                        <i class='bx bx-save'></i> Update Signature
                                    </button>
...
@push('scripts')
    ...
    <script>
        ...
        createApp({
            data() {
                return {
                    signatureType: '{{ old('signature_type', $signature->signature_type) }}',
                    imagePreview: null,
                    signatureData: '',
                    isDrawing: false,
                    ctx: null,
            ...
            methods: {
                ...
                handleSubmit(e) {
                    // For edit, it's optional to draw/upload new signature
                    return true;
                }
            }
        }).mount('#signatureApp');
